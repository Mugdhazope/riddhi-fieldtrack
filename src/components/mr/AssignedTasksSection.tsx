      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <Stethoscope className={`w-4 h-4 ${task.status === 'completed' ? 'text-secondary' : 'text-primary'}`} />
            <h4 className="font-medium text-foreground truncate">{task.doctorName}</h4>
          </div>
          <p className="text-sm text-muted-foreground mb-2">{task.doctorSpecialty}</p>
      ...
      <div className="pharma-card p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-foreground">Today's Assigned Visits</h3>
          </div>
        ...
        {todaysTasks.length === 0 ? (
          <div className="text-center py-6">
            ...
            <p className="text-muted-foreground">No assigned visits for today</p>
          </div>
        ) : (
      ...
      {upcomingTasks.length > 0 && (
        <div className="pharma-card p-6">
          ...
          {upcomingTasks.length > 5 && (
            <button className="w-full mt-4 py-2 text-sm text-primary hover:text-primary/80 flex items-center justify-center gap-1">
